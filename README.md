...
3. ***DISCLAIMER:*** I didn't Implement the new authorization feature of the API yet. You must turn "Plugins > API Server > Authorization Strategy > No Authorization" on for this to work right now. 
4. Run the `.exe`. It starts in the tray — right-click the icon for options, or left-click to open Settings.
